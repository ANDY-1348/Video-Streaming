...
class LogManager {
  ...
  constructor() {
    ...
    // In non-production environments, also log to the console for convenience
    ...
    // Optional Loggly integration controlled by env var
    ...
    this.logger.info('Local logger initialized (customized build)', {
