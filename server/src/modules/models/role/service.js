...
const search = async (searchObject) => {
  const filter = searchObject.keyword ? { name: new RegExp(searchObject.keyword), isDeleted: false } : { isDeleted: false };
...
module.exports = { insert, update, getById: Role.getObjectById };
